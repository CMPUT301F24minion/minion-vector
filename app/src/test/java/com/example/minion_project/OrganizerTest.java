...
public class OrganizerTest {
    ...
    void organizerConstructorTest() {
        ...
        Organizer organizer = new Organizer(events, "1234567890", "organizer@example.com", "John Doe", "device123", true);
    ...
    void organizerGetterSetterTest() {
        ...
        Organizer organizer = new Organizer(new ArrayList<>(), "1234567890", "organizer@example.com", "John Doe", "device123", true);
    ...
    void organizerEdgeCasesTest() {
        ...
        Organizer organizer = new Organizer(new ArrayList<>(), "", "", "", "", true);
