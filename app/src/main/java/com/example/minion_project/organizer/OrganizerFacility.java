                ...
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        ...
                        if (facilityName != null) {
                            facilityNameInput.setText(facilityName); // Set existing facility name
                        }

                        if (existingImageURL != null) {
                            // Load image into facilityImagePreview using Glide or Picasso
                            Glide.with(this)
    ...
    private void saveFacilityDetails() {
        ...
        if (imageUri != null) {
            ...
            StorageReference storageRef = FirebaseStorage.getInstance()
                    .getReference("facilities/" + organizerID + "_facility.jpg");
